package tyxo.mobilesafe.widget.badgeView;
...
public final class ShortcutBadger {
    ...
    private static final String LOG_TAG = me.leolin.shortcutbadger.ShortcutBadger.class.getSimpleName();
...
//        BADGERS.add(SamsungHomeBadger.class);
    ...
    /**
     * Tries to update the notification count, throw a {@link me.leolin.shortcutbadger.ShortcutBadgeException} if it fails
     * @param context Caller context
     * @param badgeCount Desired badge count
     */
    public static void applyCountOrThrow(Context context, int badgeCount) throws me.leolin.shortcutbadger.ShortcutBadgeException {
        ...
        try {
            ...
            throw new me.leolin.shortcutbadger.ShortcutBadgeException("Unable to execute badge:" + e.getMessage());
        }
    }
    ...
    /**
     * Tries to remove the notification count, throw a {@link me.leolin.shortcutbadger.ShortcutBadgeException} if it fails
     * @param context Caller context
     */
